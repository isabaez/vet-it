$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" name="companiesWorked"/><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            x++; //text box increment
            $(wrapper).append('<div><input type="text" name="companiesInterviewed"/><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            x++; //text box increment
            $(wrapper).append('<div><input type="text" name="eduAttended"/><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            x++; //text box increment
            $(wrapper).append('<div><input type="text" name="eduInterviewed"/><a href="#" class="remove_field">Remove</a></div>'); //add input box
        }
    });
